# myminima
`myminima` is a theme that incorporates minima with changes suggested here by [jamiddleton.com](https://jamiddleton.com/jekyll/update/2019/03/31/jekyll-mathjax-cmuserif-mlblog.html). I modified a few other layout properties to my preferences.

Documentation for this theme is more or less the same as `minima`. Documentation for `minima` is included below for reference (source: minima theme github page).
